...
tests.isNotANumber(sum(3, "1"),NaN, "Sum of 3 and 1 should return Nan");
tests.isNotANumber(sum(5, null), NaN, "Sum of 5 and null shuld return Nan");
tests.isNotANumber(sum(NaN, 2), NaN, "Sum of Nan and 2 should return Nan");
